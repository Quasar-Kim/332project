...
Run `master.jar` with number of worker machines on master machine. Following command will start `master` with two worker machines and wait for all workers to register.
