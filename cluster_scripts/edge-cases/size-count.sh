...
DIR_OUTPUT="/home/red/edge_case_output/size-count"
DIR_INPUT="/home/red/edge_case_input/size-count"
DIR_SUMMARIES="/home/red/edge_case_summaries/size-count"
...
usage() {
    ...
    echo ""
    echo "Usage: ./size-count.sh <# workers> <# directories> <# files per directory> <# records per file>"
    echo ""
    echo "Recommended to try:"
    echo "    - 1 finy file (e.g., 10 records)"
    echo "    - many tiny files (e.g., 1000 files with 10 records)"
    echo "    - 1 giant file (e.g., ???)"
    echo "    - many giant files (e.g., ???)"
}
