...
usage() {
    echo "Usage:"
    echo "    cluster_scripts/n-workers.sh <num_workers> <IP>:<m_port> -I <inputs...> -O <output> [-p <w_port>] [-r <r_port>]"
    echo ""
    echo "Arguments:"
    ...
    echo ""
    echo "Examples:"
    echo "cluster_scripts/deploy.sh n-workers 4 10.1.25.21:5000 -I /home/dir0 /home/dir2 -O /home/output"
    echo "cluster_scripts/deploy.sh n-workers 8 10.1.25.21:5000 -I /home/in -O /home/out -p 6002 -r 7001"
    echo ""
...
for worker in ${WORKER_IPS[@]:0:$N}; do
    echo "java -jar $WORKER_JAR $MASTER_IP:$M_PORT -I $input_str -O $OUTPUT --port $W_PORT --replicator-local-port $R_PORT"
